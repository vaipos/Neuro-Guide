...
const StepsCards = () => {
  return (
    ...
    <div className="relative mx-24 py-24 bg-white" style={{ height: '1200px', overflow: 'hidden' }}>

    <div className="card w-2/5 h-96 bg-neutral rounded-2xl px-10 py-5 drop-shadow-lg relative z-20" style={{ left: 'calc(100% - 42rem)' }}>
    ...
    <div className="card-container flex flex-col justify-between">
      <div className="card w-2/5 h-96 bg-neutral rounded-2xl px-10 py-4 drop-shadow-lg relative my-48 x-20" style={{ left: 'calc(100% - 85rem)' }}>
      <div className="card-body py-12">
